...
export default class LoggingSession {
  ...
  logPoint(x, y, eventId, log_time_ms) {
    if (this._sessionActive) {
      ...
      console.log("lineColumn出力:" + position)
      if(position == null) {
      ...
      var wordPos = this._editorHandler.getWordAtPosition(position)
      console.log(wordPos.value, wordPos.position.start, wordPos.position.end)
      
      this._editorHandler.findHighlightRange(position, true)
